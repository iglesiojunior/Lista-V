...
def multiplicar_valores_lista(lista):
    multiplicador = int(input("\tInsira o número que será o multiplicador dos itens da lista:"))
    print(f"""
\t=========================================
\tValores atualizados -multiplicação por {multiplicador}
\t=========================================
              """)
...
def potenciacao_valores_lista(lista):
    elevador = int(input("\tInsira o número que será o multiplicador dos itens da lista:"))
    print(f"""
\t=========================================
\tValores atualizados - potência por {elevador}
\t=========================================
              """)
    for i in range(0, len(lista)):
        lista[i] = lista[i]**elevador
        print(f"\t{lista[i]}")
    return lista  

def reduzir_valores_fracao(lista):
    numerador = 0
    denominador = 0
    numerador, denominador = map(int, input("\tInsira a fração desejada separada por /(ex: 6/12)").split("/"))
    print(f"""
\t=========================================
\tValores atualizados - redução por {numerador}/{denominador}
\t=========================================
              """)
    for i in range(0, len(lista)):
        lista[i] = lista[i]*(numerador/denominador)
        print(f"\t{lista[i]}")
    return lista
...
def substituir_valores_negativos(lista):
    valor_max = 0
    valor_min = 0
    valor_min, valor_max = map(int, input("\tInsira O valor mínimo e máximo permitido para substituir números negativos da lista: ").split(" ")) 
    for i in range(0, len(lista)):
        if lista[i] < 0:
